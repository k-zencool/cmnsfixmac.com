...
$round_on = notif_bool($pdo, 'notify_morning_enabled', true);

// 8. ส่งเข้า Telegram (ถ้าเปิดช่อง Telegram + เปิดรอบเช้า)
$res = '(skipped)';
if ($round_on && notif_bool($pdo, 'notify_telegram_enabled', true)) {
    $res = sendTelegram($msg);
}

// 8.1 ส่งเข้า LINE คู่กัน (การ์ด Flex สรุป) — ถ้าเปิดช่อง LINE + เปิดรอบเช้า
