...
$faq_schema = [
    ...
    ['Can you repair iPad Pro with Face ID?',
     'Yes. We repair iPad Pro models including M1, M2, M4 chips. Face ID sensor is always preserved during screen replacement.'],
    ['My iPad fell in water — is it recoverable?',
     'Power it off and bring it in immediately. Do not charge it. The faster you act, the better the recovery rate.'],
    ['Can you fix an iPad that won\'t turn on?',
     'Yes. Common causes include dead battery, boot loop, or logic board issue. We diagnose for free before quoting.'],
    ['Can I mail in my iPad for repair?',
...
<link rel="canonical"      href="https://cmnsfixmac.com/en/services/ipad/">
<link rel="shortcut icon"  href="/assets/img/favicon1.png">
<link rel="alternate" hreflang="th"        href="https://cmnsfixmac.com/services/ipad/">
<link rel="alternate" hreflang="en"        href="https://cmnsfixmac.com/en/services/ipad/">
<link rel="alternate" hreflang="x-default" href="https://cmnsfixmac.com/en/services/ipad/">
...
<meta property="og:url"          content="https://cmnsfixmac.com/en/services/ipad/">
...
<script type="application/ld+json"><?= json_encode([
    ...
    '@graph'   => [
        ['@type' => 'BreadcrumbList', 'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'iPad Repair', 'item' => 'https://cmnsfixmac.com/en/services/ipad/'],
        ]],
        ['@type' => 'Service',
         'name'  => 'iPad Repair Chiang Mai',
         'description' => 'iPad repair service for all models. Screen, battery, water damage, camera. Up to 6-month warranty.',
         ...
         'url'        => 'https://cmnsfixmac.com/en/services/ipad/',
        ],
...
<section class="sv-hero">
  ...
  <div class="sv-hero-inner">
    <div class="sv-hero-text" data-aos="fade-right" data-aos-duration="700">
      ...
      <h1 class="sv-h1">iPad Repair<br><span class="sv-h1-accent">All Models, Expert Care</span></h1>
    ...
    <div class="sv-hero-visual" data-aos="fade-left" data-aos-duration="700" data-aos-delay="120">
      <div class="sv-device-wrap">
        <img src="/assets/img/ipad.png" alt="iPad Repair Chiang Mai CMNS FixMac" class="sv-device-img">
        <div class="sv-float-badge sv-fbadge-1">
          <span class="material-symbols-rounded">build_circle</span>
          <div><strong>800+</strong><span>iPad Repairs</span></div>
        </div>
...
<div class="sv-nav-outer">
  <nav class="sv-nav" data-aos="fade-up" data-aos-offset="0" aria-label="Apple Repair Services">
    ...
    <a href="/en/services/ipad/"        class="sv-nav-item active"><span class="material-symbols-rounded">tablet_mac</span><span>iPad</span></a>
...
<section class="sv-section sv-services">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>Full iPad Repair Coverage</h2>
      <p class="sv-desc">We repair all iPad models — iPad, iPad Air, iPad Pro, iPad Mini — by certified technicians with quality parts and careful disassembly.</p>
    </div>
...
<section class="sv-section sv-process">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>iPad Repair in Just 4 Steps</h2>
    </div>
    <div class="sv-steps">
      <?php foreach ([
          ...
          ['3', 'build',            'Repair with Status Updates',  'Expert technicians fix your iPad. We update you via LINE.'],
          ['4', 'workspace_premium','Pick Up with Warranty Card',  'Take your iPad home with warranty covering parts & labor.'],
...
<section class="sv-section sv-gallery">
  <div class="sv-container">
    ...
    <div class="sv-view-all" data-aos="fade-up">
      <a href="/en/works/?category=iPad" class="sv-more-link">
...
<section class="sv-cta">
  <div class="sv-container">
    <div class="sv-cta-inner" data-aos="fade-up">
      ...
      <h2>iPad Screen Cracked?<br>Let Us Fix It.</h2>
