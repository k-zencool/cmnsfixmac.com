...
$page_title       = 'iPhone Repair Chiang Mai | Screen, Battery, Water Damage | CMNS FixMac';
$page_description = 'iPhone repair in Chiang Mai. Screen replacement, battery, water damage, Face ID, camera. All models including iPhone 16. Genuine parts, up to 6-month warranty.';
$page_keywords    = 'iPhone repair Chiang Mai, iPhone screen replacement, iPhone battery replacement, iPhone water damage, iPhone Face ID repair, iPhone 15 repair Chiang Mai';
$page_css         = ['/assets/css/services/iphone-style.css?v=1', 'https://unpkg.com/aos@2.3.4/dist/aos.css'];
$switch_to_lang_url = '/services/iphone/';

$faq_schema = [
    ['How much does iPhone screen replacement cost?',
     'iPhone screen replacement starts from ฿1,500 depending on the model. iPhone 14 Pro Max and newer with OLED displays cost more. Free diagnosis included.'],
    ['How long does iPhone repair take?',
     'Screen and battery replacements usually take 1–2 hours. More complex repairs like water damage or logic board take 1–2 days.'],
    ['Is Face ID affected after screen replacement?',
     'No, as long as the original Face ID sensor is transferred correctly. We always preserve your Face ID during screen repairs.'],
    ['My iPhone fell in water — what should I do?',
     'Power it off immediately and bring it to us. Do not charge it or put it in rice. The faster you come in, the better the recovery rate.'],
    ['Can you repair iPhone that won\'t turn on?',
     'Yes. Common causes include dead battery, boot loop, or logic board issue. We diagnose for free before quoting.'],
    ['Can I mail in my iPhone for repair?',
     'Yes, via Kerry or Grab. We pack it securely for return and keep you updated via LINE throughout the repair.'],
];
...
<link rel="canonical"      href="https://cmnsfixmac.com/en/services/iphone/">
<link rel="shortcut icon"  href="/assets/img/favicon1.png">
<link rel="alternate" hreflang="th"        href="https://cmnsfixmac.com/services/iphone/">
<link rel="alternate" hreflang="en"        href="https://cmnsfixmac.com/en/services/iphone/">
<link rel="alternate" hreflang="x-default" href="https://cmnsfixmac.com/en/services/iphone/">
...
<meta property="og:url"          content="https://cmnsfixmac.com/en/services/iphone/">
...
<script type="application/ld+json"><?= json_encode([
    ...
    '@graph'   => [
        ['@type' => 'BreadcrumbList', 'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'iPhone Repair',  'item' => 'https://cmnsfixmac.com/en/services/iphone/'],
        ]],
        ['@type' => 'Service',
         'name'  => 'iPhone Repair Chiang Mai',
         'description' => 'iPhone repair service for all models. Screen, battery, water damage, Face ID, camera. Up to 6-month warranty.',
         ...
         'url'        => 'https://cmnsfixmac.com/en/services/iphone/',
        ],
...
$repairs = $pdo->query(
    "SELECT id, title, model, image, views FROM repairs
     WHERE status='published' AND TRIM(LOWER(category))='iphone'
...
<section class="sv-hero">
  ...
  <div class="sv-hero-inner">
    <div class="sv-hero-text" data-aos="fade-right" data-aos-duration="700">
      ...
      <h1 class="sv-h1">iPhone Repair<br><span class="sv-h1-accent">Fast, Expert, Guaranteed</span></h1>
      <p class="sv-hero-sub">Genuine Parts · Expert Technicians · Up to 6-Month Warranty<br>Free Diagnosis Before Every Repair</p>
      ...
      <div class="sv-trust-pills">
        ...
        <span class="sv-pill"><span class="material-symbols-rounded">bolt</span> Same-Day Possible</span>
      </div>
    </div>
    <div class="sv-hero-visual" data-aos="fade-left" data-aos-duration="700" data-aos-delay="120">
      <div class="sv-device-wrap">
        <img src="/assets/img/iphone.png" alt="iPhone Repair Chiang Mai CMNS FixMac" class="sv-device-img">
        <div class="sv-float-badge sv-fbadge-1">
          <span class="material-symbols-rounded">build_circle</span>
          <div><strong>2,000+</strong><span>iPhone Repairs</span></div>
        </div>
        <div class="sv-float-badge sv-fbadge-2">
          <span class="material-symbols-rounded">workspace_premium</span>
          <div><strong>Up to 6-Month Warranty</strong><span>Parts & labor covered</span></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="sv-nav-outer">
  <nav class="sv-nav" data-aos="fade-up" data-aos-offset="0" aria-label="Apple Repair Services">
    ...
    <a href="/en/services/iphone/"      class="sv-nav-item active"><span class="material-symbols-rounded">smartphone</span><span>iPhone</span></a>
...
<section class="sv-section sv-services">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>Full iPhone Repair Coverage</h2>
      <p class="sv-desc">We repair all iPhone models — from iPhone 6 to iPhone 16 — by certified technicians with quality parts and careful handling.</p>
    </div>
    <div class="sv-card-grid">
      <?php foreach ([
          ['display_settings', 'Screen Replacement', 'Cracked glass, OLED lines, touch not working. Genuine OLED/LCD replacements that preserve Face ID.', 'From ฿1,500'],
          ['battery_alert',    'Battery Replacement', 'Battery draining fast, swollen, won\'t charge. Original-grade battery with proper health restoration.', 'From ฿990'],
          ['water_drop',       'Water Damage',        'Dropped in water? Power off immediately and bring it in. Do not charge. We clean and repair the board.', 'Quote on inspection'],
          ['photo_camera',     'Camera Repair',       'Blurry photos, camera not opening, front/rear camera failure. Replacement and module-level repair.', 'From ฿1,200'],
          ['face_retouching',  'Face ID / Touch ID',  'Face ID not working, Touch ID failure, home button issues. Careful sensor transfer during repairs.', 'Quote on inspection'],
...
<section class="sv-stats">
  <div class="sv-container sv-stats-inner">
    <?php foreach ([
        ['2,000+', 'iPhone Repairs',         'build'],
        ['10+',    'Years Experience',         'engineering'],
        ['4.9★',   'Google Reviews',           'star'],
        ['Up to 6-Month Warranty', 'Parts & labor covered', 'workspace_premium'],
    ] as $i => [$num, $label, $icon]): ?>
...
<section class="sv-section sv-pricing" id="sv-pricing">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>Transparent iPhone Repair Pricing</h2>
...
<section class="sv-section sv-process">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>iPhone Repair in Just 4 Steps</h2>
    </div>
    <div class="sv-steps">
      <?php foreach ([
          ['1', 'call',             'Bring In or Ship It',        'Visit us in Chiang Mai or ship via Kerry / Grab.'],
          ['2', 'search',           'Free Diagnosis & Quote',      'We inspect and give you a price before touching anything.'],
          ['3', 'build',            'Repair with Status Updates',  'Expert technicians fix your iPhone. We update you via LINE.'],
          ['4', 'workspace_premium','Pick Up with Warranty Card',  'Take your iPhone home with warranty covering parts & labor.'],
...
<section class="sv-section sv-gallery">
  <div class="sv-container">
    ...
    <div class="sv-view-all" data-aos="fade-up">
      <a href="/en/works/?category=iPhone" class="sv-more-link">
...
<section class="sv-cta">
  <div class="sv-container">
    <div class="sv-cta-inner" data-aos="fade-up">
      <span class="material-symbols-rounded sv-cta-icon">smartphone</span>
      <h2>iPhone Broken?<br>Let Us Fix It Fast.</h2>
      <p>Free diagnosis · Genuine parts · Up to 6-month warranty<br>Expert technicians available Mon–Sat 9:00–19:00</p>
