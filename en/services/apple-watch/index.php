...
$page_title       = 'Apple Watch Repair Chiang Mai | Screen, Battery | CMNS FixMac';
$page_description = 'Apple Watch repair in Chiang Mai. Screen replacement, battery, water damage, Digital Crown, charging port. All Series. Genuine parts, up to 3-month warranty.';
$page_keywords    = 'Apple Watch repair Chiang Mai, Apple Watch screen replacement, Apple Watch battery replacement, Apple Watch Series 9 repair, Apple Watch Ultra repair';
$page_css         = ['/assets/css/services/apple-watch-style.css?v=1', 'https://unpkg.com/aos@2.3.4/dist/aos.css'];
$switch_to_lang_url = '/services/apple-watch/';

$faq_schema = [
    ['How much does Apple Watch screen replacement cost?',
     'Apple Watch screen replacement starts from ฿1,500 depending on the Series. Ultra and newer models cost more. Free diagnosis included.'],
    ['How long does Apple Watch repair take?',
     'Screen and battery replacements take 2–3 days. Apple Watch requires very precise disassembly. We update you via LINE throughout.'],
    ['Can you repair Apple Watch Ultra / Series 9?',
     'Yes. We repair all Apple Watch models from Series 3 onwards including Ultra and Ultra 2. Free diagnosis before any repair.'],
    ['My Apple Watch got wet — is it still repairable?',
     'Apple Watch is rated water resistant but not fully waterproof. If yours stopped working after exposure to water, bring it in for diagnosis immediately.'],
    ['Can you fix Apple Watch that won\'t turn on?',
     'Yes. Common causes include dead battery, software lock, or logic board issue. We diagnose for free before quoting.'],
    ['Is Apple Watch band replacement available?',
     'Yes, we have a selection of replacement bands in multiple styles and colors. Bring your watch in to find the right fit.'],
];
...
<link rel="canonical"      href="https://cmnsfixmac.com/en/services/apple-watch/">
<link rel="shortcut icon"  href="/assets/img/favicon1.png">
<link rel="alternate" hreflang="th"        href="https://cmnsfixmac.com/services/apple-watch/">
<link rel="alternate" hreflang="en"        href="https://cmnsfixmac.com/en/services/apple-watch/">
<link rel="alternate" hreflang="x-default" href="https://cmnsfixmac.com/en/services/apple-watch/">
...
<meta property="og:url"          content="https://cmnsfixmac.com/en/services/apple-watch/">
...
<script type="application/ld+json"><?= json_encode([
    ...
    '@graph'   => [
        ['@type' => 'BreadcrumbList', 'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'Apple Watch Repair', 'item' => 'https://cmnsfixmac.com/en/services/apple-watch/'],
        ]],
        ['@type' => 'Service',
         'name'  => 'Apple Watch Repair Chiang Mai',
         'description' => 'Apple Watch repair for all Series. Screen, battery, water damage, Digital Crown. Up to 3-month warranty.',
         ...
         'url'        => 'https://cmnsfixmac.com/en/services/apple-watch/',
        ],
...
<section class="sv-hero">
  ...
  <div class="sv-hero-inner">
    <div class="sv-hero-text" data-aos="fade-right" data-aos-duration="700">
      ...
      <h1 class="sv-h1">Apple Watch Repair<br><span class="sv-h1-accent">All Series, Expert Care</span></h1>
      ...
      <div class="sv-trust-pills">
        ...
        <span class="sv-pill"><span class="material-symbols-rounded">bolt</span> 2–3 Days</span>
      </div>
    </div>
    <div class="sv-hero-visual" data-aos="fade-left" data-aos-duration="700" data-aos-delay="120">
      <div class="sv-device-wrap">
        <img src="/assets/img/watch.png" alt="Apple Watch Repair Chiang Mai CMNS FixMac" class="sv-device-img">
        <div class="sv-float-badge sv-fbadge-1">
          <span class="material-symbols-rounded">build_circle</span>
          <div><strong>300+</strong><span>Apple Watch Repairs</span></div>
        </div>
...
<div class="sv-nav-outer">
  <nav class="sv-nav" data-aos="fade-up" data-aos-offset="0" aria-label="Apple Repair Services">
    ...
    <a href="/en/services/apple-watch/" class="sv-nav-item active"><span class="material-symbols-rounded">watch</span><span>Apple Watch</span></a>
...
<section class="sv-section sv-services">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>Full Apple Watch Repair Coverage</h2>
      <p class="sv-desc">We repair all Apple Watch Series — from Series 3 to Series 10, Ultra and Ultra 2 — with precision tools and quality replacement parts.</p>
    </div>
    <div class="sv-card-grid">
      <?php foreach ([
          ['display_settings', 'Screen Replacement',   'Cracked OLED / LTPO display, touch not working. Genuine panel replacement with care for the seals.', 'From ฿1,500'],
          ['battery_alert',    'Battery Replacement',   'Battery draining too fast, swollen, won\'t charge past 80%. We replace with proper capacity cells.', 'From ฿1,200'],
          ['water_drop',       'Water Damage',          'Even water-resistant watches can fail after deep submersion. We clean and repair the internals.', 'Quote on inspection'],
          ['rotate_right',     'Digital Crown Repair',  'Stuck, scratchy, or unresponsive Digital Crown. We clean and replace the crown assembly.', 'From ฿800'],
          ['power',            'Won\'t Power On',       'Dead battery, software lock, or board fault. We diagnose and fix or recover your data.', 'Quote on inspection'],
          ['watch_later',      'Band Replacement',      'Cracked or worn-out band. We have replacement bands in sport, leather, and Milanese Loop styles.', 'From ฿390'],
...
<section class="sv-section sv-pricing" id="sv-pricing">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>Transparent Apple Watch Repair Pricing</h2>
      <p class="sv-desc">Approximate prices — varies by Series and condition. <strong>Free diagnosis before every job.</strong></p>
    </div>
    ...
    <p class="sv-price-note" data-aos="fade-up">
      ...
      Prices are approximate and may vary by Series and actual condition.
...
<section class="sv-section sv-process">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>Apple Watch Repair in Just 4 Steps</h2>
    </div>
    <div class="sv-steps">
      <?php foreach ([
          ['1', 'call',             'Bring In or Ship It',         'Visit us in Chiang Mai or ship via Kerry / Grab.'],
          ['2', 'search',           'Free Diagnosis & Quote',       'We inspect the watch and give you a price before touching anything.'],
          ['3', 'build',            'Repair with Status Updates',   'Expert technicians fix your Apple Watch. We update you via LINE.'],
          ['4', 'workspace_premium','Pick Up with Warranty Card',   'Take your watch home with warranty covering parts & labor.'],
...
<section class="sv-section sv-gallery">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>Apple Watch Repair Gallery</h2>
    ...
    <div class="sv-view-all" data-aos="fade-up">
      <a href="/en/works/?category=AppleWatch" class="sv-more-link">
...
<section class="sv-cta">
  <div class="sv-container">
    <div class="sv-cta-inner" data-aos="fade-up">
      ...
      <h2>Apple Watch Screen Cracked?<br>We've Got You.</h2>
