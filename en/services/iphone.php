...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/services/iphone-style.css"> 
    ...
    <main>
        ...
        <section class="fix-result container">
            <h2 data-aos="fade-up">Examples of Our iPhone Repairs</h2> <div class="fix-result-grid">
                ...
                $stmt_repairs = $pdo->prepare("SELECT id, image, title, title_en, model, views FROM repairs WHERE status = 'published' AND LOWER(category) = 'iphone' ORDER BY created_at DESC LIMIT 6");
