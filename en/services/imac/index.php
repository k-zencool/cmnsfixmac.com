...
$faq_schema = [
    ...
    ['Can you repair older iMac models?',
     'Yes. We service iMac models from 2012 onwards including iMac Pro. SSD/RAM upgrades are available on pre-Fusion iMacs.'],
    ['My iMac won\'t turn on — is it fixable?',
     'Usually yes. Common causes include power supply failure, logic board issues, or blown fuses. Bring it in for a free inspection.'],
    ['Can you upgrade the iMac SSD to NVMe?',
     'Yes, we can install NVMe SSDs in compatible iMac models for a significant speed boost at a fraction of Apple\'s cost.'],
    ['Can I mail in my iMac for repair?',
     'We recommend bringing it in person due to the iMac\'s size, but we can arrange pickup/delivery within Chiang Mai.'],
];
...
<link rel="canonical"      href="https://cmnsfixmac.com/en/services/imac/">
<link rel="shortcut icon"  href="/assets/img/favicon1.png">
<link rel="alternate" hreflang="th"        href="https://cmnsfixmac.com/services/imac/">
<link rel="alternate" hreflang="en"        href="https://cmnsfixmac.com/en/services/imac/">
<link rel="alternate" hreflang="x-default" href="https://cmnsfixmac.com/en/services/imac/">
...
<meta property="og:url"          content="https://cmnsfixmac.com/en/services/imac/">
...
<script type="application/ld+json"><?= json_encode([
    ...
    '@graph'   => [
        ['@type' => 'BreadcrumbList', 'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'iMac Repair', 'item' => 'https://cmnsfixmac.com/en/services/imac/'],
        ]],
        ['@type' => 'Service',
         'name'  => 'iMac Repair Chiang Mai',
         'description' => 'iMac repair service for all models. Screen, SSD upgrade, logic board, power issues. Genuine parts, up to 1-year warranty.',
         ...
         'url'        => 'https://cmnsfixmac.com/en/services/imac/',
        ],
...
<section class="sv-hero">
  ...
  <div class="sv-hero-inner">
    <div class="sv-hero-text" data-aos="fade-right" data-aos-duration="700">
      ...
      <h1 class="sv-h1">iMac Repair<br><span class="sv-h1-accent">All Models, All Issues</span></h1>
      ...
      <div class="sv-trust-pills">
        ...
        <span class="sv-pill"><span class="material-symbols-rounded">bolt</span> 2–5 Days</span>
      </div>
    </div>
    <div class="sv-hero-visual" data-aos="fade-left" data-aos-duration="700" data-aos-delay="120">
      <div class="sv-device-wrap">
        <img src="/assets/img/mac.png" alt="iMac Repair Chiang Mai CMNS FixMac" class="sv-device-img">
        <div class="sv-float-badge sv-fbadge-1">
          <span class="material-symbols-rounded">build_circle</span>
          <div><strong>500+</strong><span>iMac Repairs</span></div>
        </div>
...
<div class="sv-nav-outer">
  <nav class="sv-nav" data-aos="fade-up" data-aos-offset="0" aria-label="Apple Repair Services">
    ...
    <a href="/en/services/imac/"        class="sv-nav-item active"><span class="material-symbols-rounded">desktop_mac</span><span>iMac</span></a>
...
<section class="sv-section sv-services">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>Full iMac Repair Coverage</h2>
      <p class="sv-desc">We repair all iMac and iMac Pro models — 21.5", 24", 27" — by certified technicians with quality parts and careful disassembly.</p>
    </div>
...
<section class="sv-section sv-process">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>iMac Repair in Just 4 Steps</h2>
    </div>
    <div class="sv-steps">
      <?php foreach ([
          ['1', 'call',             'Bring In Your iMac',           'Visit us in Chiang Mai. We can arrange pickup/delivery within the city.'],
          ['2', 'search',           'Free Diagnosis & Quote',        'We inspect carefully and give you a price before opening anything.'],
          ['3', 'build',            'Repair with Status Updates',    'Expert technicians work on your iMac. We update you via LINE.'],
          ['4', 'workspace_premium','Pick Up with Warranty Card',    'Take your iMac home with a 1 month–1 year warranty covering parts & labor.'],
...
<section class="sv-section sv-gallery">
  <div class="sv-container">
    ...
    <div class="sv-view-all" data-aos="fade-up">
      <a href="/en/works/?category=iMac" class="sv-more-link">
...
<section class="sv-cta">
  <div class="sv-container">
    <div class="sv-cta-inner" data-aos="fade-up">
      ...
      <h2>iMac Acting Up?<br>Let Us Fix It.</h2>
