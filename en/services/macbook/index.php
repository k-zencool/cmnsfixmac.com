...
<section class="sv-section sv-services">
  <div class="sv-container">
    ...
    <div class="sv-card-grid">
      <?php foreach ([
          ['display_settings', 'Screen Replacement',       'Cracked, lines, dead pixels, no image. We replace Retina / Liquid Retina displays for all sizes.', 'Ask for a quote'],
          ['battery_alert',    'Battery Replacement',       'Degraded battery, won\'t charge, swollen. Genuine battery replacement for all models with warranty.', 'Ask for a quote'],
          ...
          ['storage',          'SSD / RAM Upgrade',         'More storage, faster performance. Available for Intel MacBooks with user-upgradeable components.', 'Ask for a quote'],
          ['terminal',         'macOS & Software',          'Clean macOS install, fix slow boot, install Office, Adobe, AutoCAD and other software.', 'Ask for a quote'],
