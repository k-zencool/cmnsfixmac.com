...
$page_title       = 'MacBook Repair Chiang Mai | All Models, All Issues | CMNS FixMac';
$page_description = 'MacBook repair in Chiang Mai. Screen, battery, water damage, logic board. All models incl. M1/M2/M3/M4. Genuine parts, up to 1-year warranty. Free diagnosis every time.';
$page_keywords    = 'MacBook repair Chiang Mai, MacBook screen replacement, MacBook battery replacement, MacBook water damage, MacBook M1 repair, MacBook M3 repair';
$page_css         = ['/assets/css/services/macbook-style.css?v=3', 'https://unpkg.com/aos@2.3.4/dist/aos.css'];
$switch_to_lang_url = '/services/macbook/';

$faq_schema = [
    ['How much does MacBook repair cost?',
     'Prices vary by model and issue. Screen replacement starts from ฿5,900, battery replacement from ฿2,900. Every job includes a free diagnosis before we start.'],
    ['How long does MacBook repair take?',
     'Common repairs like screen or battery replacement take 1–3 days. Some jobs can be done same day depending on parts availability.'],
    ['Is the repair covered by warranty?',
     'Yes. Every repair comes with a 1–12 month warranty depending on the job type, covering both parts and labor. Bring it back for a free claim within the warranty period.'],
    ['Can you repair MacBook M1 / M2 / M3?',
     'Yes. Our technicians are experienced with all Apple Silicon MacBooks — screen replacement, battery, and logic board component-level repairs.'],
    ['My MacBook got wet — is it recoverable?',
     'Usually yes, if you bring it in quickly. Do not power it on. We clean the board and repair damaged components.'],
...
<link rel="canonical"      href="https://cmnsfixmac.com/en/services/macbook/">
<link rel="shortcut icon"  href="/assets/img/favicon1.png">
<link rel="alternate" hreflang="th"        href="https://cmnsfixmac.com/services/macbook/">
<link rel="alternate" hreflang="en"        href="https://cmnsfixmac.com/en/services/macbook/">
<link rel="alternate" hreflang="x-default" href="https://cmnsfixmac.com/en/services/macbook/">
...
<meta property="og:url"          content="https://cmnsfixmac.com/en/services/macbook/">
...
<script type="application/ld+json"><?= json_encode([
    ...
    '@graph'   => [
        ['@type' => 'BreadcrumbList', 'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'MacBook Repair', 'item' => 'https://cmnsfixmac.com/en/services/macbook/'],
        ]],
        ['@type' => 'Service',
         'name'  => 'MacBook Repair Chiang Mai',
         'description' => 'MacBook repair service for all models and issues. Genuine parts, up to 1-year warranty.',
         ...
         'url'        => 'https://cmnsfixmac.com/en/services/macbook/',
        ],
...
<section class="sv-hero">
  ...
  <div class="sv-hero-inner">
    <div class="sv-hero-text" data-aos="fade-right" data-aos-duration="700">
      ...
      <h1 class="sv-h1">MacBook Repair<br><span class="sv-h1-accent">All Models, All Issues</span></h1>
      <p class="sv-hero-sub">Genuine Parts · Expert Technicians · Up to 1-Year Warranty<br>Free Diagnosis Before Every Repair</p>
      ...
      <div class="sv-trust-pills">
        ...
        <span class="sv-pill"><span class="material-symbols-rounded">bolt</span> 1–3 Days</span>
      </div>
    </div>
    <div class="sv-hero-visual" data-aos="fade-left" data-aos-duration="700" data-aos-delay="120">
      <div class="sv-device-wrap">
        <img src="/assets/img/macbook.png" alt="MacBook Repair Chiang Mai CMNS FixMac" class="sv-device-img">
        <div class="sv-float-badge sv-fbadge-1">
          <span class="material-symbols-rounded">build_circle</span>
          <div><strong>1,200+</strong><span>MacBook Repairs</span></div>
        </div>
        <div class="sv-float-badge sv-fbadge-2">
          <span class="material-symbols-rounded">workspace_premium</span>
          <div><strong>Up to 1-Year Warranty</strong><span>1 month–1 year by job type</span></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="sv-nav-outer">
  <nav class="sv-nav" data-aos="fade-up" data-aos-offset="0" aria-label="Apple Repair Services">
    <a href="/en/services/macbook/"    class="sv-nav-item active"><span class="material-symbols-rounded">laptop_mac</span><span>MacBook</span></a>
...
<section class="sv-section sv-services">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>Full MacBook Repair Coverage</h2>
      <p class="sv-desc">We repair all MacBook Air / Pro models — Intel, M1, M2, M3, M4 — by our team of expert technicians with quality parts.</p>
    </div>
    <div class="sv-card-grid">
      <?php foreach ([
          ['display_settings', 'Screen Replacement',       'Cracked, lines, dead pixels, no image. We replace Retina / Liquid Retina displays for all sizes.', 'From ฿5,900'],
          ['battery_alert',    'Battery Replacement',       'Degraded battery, won\'t charge, swollen. Genuine battery replacement for all models with warranty.', 'From ฿2,900'],
          ['memory',           'Logic Board Repair',        'Won\'t power on, shuts down, short circuit, water damage. Component-level board repair.', 'Quote on inspection'],
          ['water_drop',       'Water Damage',              'Spilled liquid, board cleaning, chip repair, data recovery. Bring it in immediately — do not power on.', 'Quote on inspection'],
          ['storage',          'SSD / RAM Upgrade',         'More storage, faster performance. Available for Intel MacBooks with user-upgradeable components.', 'From ฿2,500'],
          ['terminal',         'macOS & Software',          'Clean macOS install, fix slow boot, install Office, Adobe, AutoCAD and other software.', 'From ฿500'],
...
<section class="sv-stats">
  <div class="sv-container sv-stats-inner">
    <?php foreach ([
        ['1,200+', 'MacBook Repairs',       'build'],
        ['10+',    'Years Experience',       'engineering'],
        ['4.9★',   'Google Reviews',         'star'],
        ['Up to 1-Year Warranty', '1 month–1 year by job type', 'workspace_premium'],
    ] as $i => [$num, $label, $icon]): ?>
...
<section class="sv-section sv-pricing" id="sv-pricing">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>Transparent MacBook Repair Pricing</h2>
...
<section class="sv-section sv-process">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>MacBook Repair in Just 4 Steps</h2>
    </div>
    <div class="sv-steps">
      <?php foreach ([
          ...
          ['3', 'build',            'Repair with Status Updates',    'Expert technicians fix your MacBook. We update you via LINE.'],
          ['4', 'workspace_premium','Pick Up with Warranty Card', 'Take your MacBook home with a 1 month–1 year warranty covering parts & labor.'],
...
<section class="sv-section sv-gallery">
  <div class="sv-container">
    ...
    <div class="sv-view-all" data-aos="fade-up">
      <a href="/en/works/?category=MacBook" class="sv-more-link">
...
<section class="sv-cta">
  <div class="sv-container">
    <div class="sv-cta-inner" data-aos="fade-up">
      ...
      <h2>MacBook Acting Up?<br>Let Us Fix It.</h2>
      <p>Free diagnosis · Genuine parts · Up to 1-year warranty<br>Expert technicians available Mon–Sat 9:00–19:00</p>
