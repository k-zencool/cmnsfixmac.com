...
<head>
  ...
  // This code assumes the page has already fetched the item's data into an array like $product or $data

  // First, find the correct ID from the available array
  $currentItemId = 0;
  if (isset($product['id'])) {
  ...
  // Then, determine the correct page filename
  $currentPageName = basename($_SERVER['SCRIPT_FILENAME']); // e.g., 'product-detail.php' or 'work-detail.php'
