...
<footer class="footer">
  <div class="footer-inner">
    ...
    <div class="footer-brand">
      <a href="/en/"><img src="/assets/img/Logo1.png" alt="CMNS FixMac" class="footer-logo"></a>
      <p class="footer-tagline">Apple Repair Shop — Chiang Mai<br>by certified specialists, 10+ years experience</p>
    ...
    <div class="footer-col">
      ...
      <ul class="footer-links">
        ...
        <li><a href="/en/buyback/">Sell Your Device</a></li>
        <li><a href="/en/warranty/">Warranty Check</a></li>
      </ul>
    </div>
      ...
      <ul class="footer-links">
        ...
        <li>
          <a href="https://maps.app.goo.gl/bDboFFwykRSCSMX7A" target="_blank" rel="noopener">
            ...
            482 Moo 8, Behind Kad Varun<br>Mae Hia, Chiang Mai 50100
          </a>
        </li>
      </ul>
    </div>
  ...
  <div class="footer-bottom">
    <p>&copy; <?= date('Y') ?> CMNS Fix Mac — Expert Mac & iPhone Repair Chiang Mai</p>
