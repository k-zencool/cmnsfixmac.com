...
<main>
    ...
    <section class="fix-result container">
        ...
        <div class="fix-result-grid">
            <?php
            $stmt = $pdo->prepare("SELECT * FROM repairs WHERE status = 'published' AND LOWER(category) = 'ipad' ORDER BY created_at DESC LIMIT 6");
            $stmt->execute();
        ...
        <div class="view-all-link" data-aos="fade-up">
            <a href="/works/?category=iPad" class="btn-orange">ดูผลงานทั้งหมด</a>
        </div>
    </section>
</main>
