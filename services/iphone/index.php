...
$page_title       = 'ซ่อม iPhone เชียงใหม่ ทุกรุ่น ทุกอาการ | CMNS FixMac';
$page_description = 'ซ่อม iPhone ทุกรุ่น จอแตก แบตเสื่อม น้ำเข้า กล้องพัง ช่างผู้เชี่ยวชาญเชียงใหม่ อะไหล่แท้ ประกันสูงสุด 6 เดือน ประเมินฟรี';
$page_keywords    = 'ซ่อม iPhone เชียงใหม่, เปลี่ยนจอ iPhone, เปลี่ยนแบต iPhone, iPhone น้ำเข้า, ซ่อม iPhone 15, ซ่อม iPhone 16 Pro Max, ราคาซ่อม iPhone เชียงใหม่';
$page_css         = ['/assets/css/services/iphone-style.css?v=1', 'https://unpkg.com/aos@2.3.4/dist/aos.css'];

$faq_schema = [
    ['ซ่อม iPhone ที่ CMNS FixMac ราคาเท่าไหร่?',
     'ราคาขึ้นอยู่กับรุ่นและอาการ เช่น เปลี่ยนจอ iPhone 15 Pro เริ่มที่ 3,900 บาท เปลี่ยนแบตเริ่มที่ 990 บาท ทุกงานประเมินฟรีก่อนตัดสินใจ'],
    ['ใช้เวลาซ่อม iPhone นานแค่ไหน?',
     'งานทั่วไปเช่น เปลี่ยนจอ เปลี่ยนแบต ใช้เวลา 1–2 ชั่วโมง ถึง 1 วัน บางงานรอรับได้เลยในวันเดียวกัน'],
    ['iPhone ที่ซ่อมมีประกันไหม?',
     'มีประกันทุกงานซ่อม 1–6 เดือน ขึ้นอยู่กับประเภทงาน ครอบคลุมทั้งอะไหล่และค่าแรง นำมาเคลมได้ฟรีในช่วงประกัน'],
    ['iPhone 15 / 16 ซ่อมได้ไหม?',
     'ซ่อมได้ ทีมช่างมีประสบการณ์กับ iPhone ทุก Series ทั้ง iPhone 15, 15 Pro, 16, 16 Pro Max'],
    ['iPhone โดนน้ำ ยังกู้คืนได้ไหม?',
     'ส่วนใหญ่กู้ได้หากนำมาทันที อย่าเปิดเครื่องต่อ เราล้างบอร์ดและซ่อมชิปที่เสียหาย'],
...
<link rel="canonical"      href="https://cmnsfixmac.com/services/iphone/">
...
<meta property="og:url"          content="https://cmnsfixmac.com/services/iphone/">
...
<script type="application/ld+json"><?= json_encode([
    ...
    '@graph'   => [
        ['@type' => 'BreadcrumbList', 'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'ซ่อม iPhone','item' => 'https://cmnsfixmac.com/services/iphone/'],
        ]],
        ['@type' => 'Service',
         'name'  => 'ซ่อม iPhone เชียงใหม่',
         'description' => 'บริการซ่อม iPhone ทุกรุ่น ทุกอาการ โดยช่างผู้เชี่ยวชาญ อะไหล่แท้ ประกันสูงสุด 6 เดือน',
         ...
         'url'        => 'https://cmnsfixmac.com/services/iphone/',
        ],
...
<section class="sv-hero">
  ...
  <div class="sv-hero-inner">
    ...
    <div class="sv-hero-text" data-aos="fade-right" data-aos-duration="700">
      ...
      <h1 class="sv-h1">ซ่อม iPhone<br><span class="sv-h1-accent">ทุกรุ่น ทุกอาการ</span></h1>
      <p class="sv-hero-sub">อะไหล่คุณภาพ ช่างผู้เชี่ยวชาญ ประกันสูงสุด 6 เดือน<br>ประเมินฟรีก่อนตัดสินใจทุกครั้ง</p>
    ...
    <div class="sv-hero-visual" data-aos="fade-left" data-aos-duration="700" data-aos-delay="120">
      <div class="sv-device-wrap">
        <img src="/assets/img/iphone.png" alt="ซ่อม iPhone เชียงใหม่ CMNS FixMac" class="sv-device-img">
        <div class="sv-float-badge sv-fbadge-1">
          <span class="material-symbols-rounded">build_circle</span>
          <div><strong>2,000+</strong><span>งานซ่อม iPhone</span></div>
        </div>
        <div class="sv-float-badge sv-fbadge-2">
          <span class="material-symbols-rounded">workspace_premium</span>
          <div><strong>ประกันสูงสุด 6 เดือน</strong><span>1–6 เดือน แล้วแต่งาน</span></div>
        </div>
      </div>
    </div>
...
<div class="sv-nav-outer">
  <nav class="sv-nav" data-aos="fade-up" data-aos-offset="0" aria-label="บริการซ่อม Apple">
    ...
    <a href="/services/iphone/"     class="sv-nav-item active"><span class="material-symbols-rounded">smartphone</span><span>iPhone</span></a>
...
<section class="sv-section sv-services">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>ซ่อม iPhone ครบทุกประเภท</h2>
      <p class="sv-desc">รับซ่อม iPhone ทุก Series ตั้งแต่ iPhone 6 ถึง 16 Pro Max โดยทีมช่างผู้เชี่ยวชาญ</p>
    </div>
    <div class="sv-card-grid">
      <?php foreach ([
          ['display_settings', 'เปลี่ยนจอ iPhone',        'จอแตก จอมีเส้น หน้าจอค้าง ไม่ตอบสนอง เปลี่ยน OLED / LCD ทุกรุ่น',        'เริ่ม 1,500 บาท'],
          ['battery_alert',    'เปลี่ยนแบตเตอรี่',        'แบตเสื่อม ชาร์จไม่อยู่ เปอร์เซ็นต์แบตหาย รับเปลี่ยนแบตทุกรุ่น',           'เริ่ม 990 บาท'],
          ['water_drop',       'iPhone โดนน้ำ',            'น้ำเข้า เครื่องดับ ล้างบอร์ด ซ่อมชิปที่เสียหาย กู้ข้อมูล',                'ประเมินหน้างาน'],
          ['photo_camera',     'เปลี่ยนกล้อง',             'กล้องพัง โฟกัสไม่ได้ ภาพเบลอ รับเปลี่ยนกล้องหน้า / หลังทุกรุ่น',          'เริ่ม 1,200 บาท'],
          ['face_retouching',  'ซ่อม Face ID / Touch ID', 'Face ID ไม่ทำงาน Touch ID ไม่ตอบสนอง ซ่อม sensor และชิป',                 'ประเมินหน้างาน'],
          ['memory',           'ซ่อม Logic Board',         'iPhone ดับ loop reboot เปิดไม่ติด ซ่อมระดับชิป',                            'ประเมินหน้างาน'],
...
<section class="sv-stats">
  <div class="sv-container sv-stats-inner">
    <?php foreach ([
        ['2,000+', 'งานซ่อม iPhone',        'build'],
        ['10+',    'ปีประสบการณ์',           'engineering'],
        ['4.9★',   'Google Reviews',         'star'],
        ['ประกันสูงสุด 6 เดือน', '1–6 เดือน แล้วแต่งาน', 'workspace_premium'],
    ] as $i => [$num, $label, $icon]): ?>
...
<section class="sv-section sv-pricing" id="sv-pricing">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>ราคาซ่อม iPhone โปร่งใส ไม่มีบวกเพิ่ม</h2>
...
<section class="sv-section sv-process">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>ซ่อม iPhone กับเรา ง่ายแค่ 4 ขั้นตอน</h2>
    </div>
    <div class="sv-steps">
      <?php foreach ([
          ...
          ['4', 'workspace_premium','รับเครื่อง พร้อมใบรับประกัน', 'รับเครื่องพร้อมใบรับประกัน 1–6 เดือน ขึ้นอยู่กับประเภทงาน'],
...
<section class="sv-section sv-gallery">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>ตัวอย่างผลงานซ่อม iPhone</h2>
    ...
    <div class="sv-view-all" data-aos="fade-up">
      <a href="/works/?category=iPhone" class="sv-more-link">
...
<section class="sv-section sv-faq">
  <div class="sv-container sv-faq-wrap">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>คำถามที่พบบ่อย ซ่อม iPhone</h2>
    </div>
...
<section class="sv-cta">
  <div class="sv-container">
    <div class="sv-cta-inner" data-aos="fade-up">
      ...
      <h2>iPhone มีปัญหา?<br>ให้เราดูแลให้</h2>
      <p>ประเมินฟรี ไม่มีค่าใช้จ่าย · อะไหล่แท้ · ประกันสูงสุด 6 เดือน<br>ช่างผู้เชี่ยวชาญพร้อมรับเครื่องทุกวัน จ.–ส. 9:00–19:00</p>
