...
<section class="sv-section sv-services">
  <div class="sv-container">
    ...
    <div class="sv-card-grid">
      <?php foreach ([
          ['display_settings', 'เปลี่ยนจอ iPhone',        'จอแตก จอมีเส้น หน้าจอค้าง ไม่ตอบสนอง เปลี่ยน OLED / LCD ทุกรุ่น',        'สอบถามราคา'],
          ['battery_alert',    'เปลี่ยนแบตเตอรี่',        'แบตเสื่อม ชาร์จไม่อยู่ เปอร์เซ็นต์แบตหาย รับเปลี่ยนแบตทุกรุ่น',           'สอบถามราคา'],
          ['water_drop',       'iPhone โดนน้ำ',            'น้ำเข้า เครื่องดับ ล้างบอร์ด ซ่อมชิปที่เสียหาย กู้ข้อมูล',                'ประเมินหน้างาน'],
          ['photo_camera',     'เปลี่ยนกล้อง',             'กล้องพัง โฟกัสไม่ได้ ภาพเบลอ รับเปลี่ยนกล้องหน้า / หลังทุกรุ่น',          'สอบถามราคา'],
