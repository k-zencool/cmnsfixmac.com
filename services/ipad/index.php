...
<section class="sv-section sv-services">
  <div class="sv-container">
    ...
    <div class="sv-card-grid">
      <?php foreach ([
          ['display_settings', 'เปลี่ยนจอ iPad',         'จอแตก จอลาย จอไม่ติด ไม่ตอบสนอง เปลี่ยน Retina LCD / OLED ทุกรุ่น', 'สอบถามราคา'],
          ['battery_alert',    'เปลี่ยนแบตเตอรี่',       'แบตเสื่อม ชาร์จไม่อยู่ iPad ดับเร็ว รับเปลี่ยนแบตทุกรุ่น',           'สอบถามราคา'],
          ['water_drop',       'iPad โดนน้ำ',             'น้ำเข้า เครื่องดับ ล้างบอร์ด ซ่อมชิปที่เสียหาย กู้ข้อมูล',           'ประเมินหน้างาน'],
          ['photo_camera',     'เปลี่ยนกล้อง',            'กล้องพัง ภาพเบลอ โฟกัสไม่ได้ เปลี่ยนกล้องหน้า / หลัง',              'สอบถามราคา'],
          ['home_pin',         'เปลี่ยนปุ่ม Home',        'ปุ่ม Home กด response ไม่ดี หรือพัง Touch ID ไม่ทำงาน',              'สอบถามราคา'],
