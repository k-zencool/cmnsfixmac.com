...
$page_title       = 'ซ่อม iPad เชียงใหม่ ทุกรุ่น ทุกอาการ | CMNS FixMac';
$page_description = 'ซ่อม iPad ทุกรุ่น จอแตก แบตเสื่อม น้ำเข้า กล้องพัง ช่างผู้เชี่ยวชาญเชียงใหม่ อะไหล่แท้ ประกันสูงสุด 6 เดือน ประเมินฟรี';
$page_keywords    = 'ซ่อม iPad เชียงใหม่, เปลี่ยนจอ iPad, เปลี่ยนแบต iPad, iPad น้ำเข้า, ซ่อม iPad Pro, ซ่อม iPad Air, ราคาซ่อม iPad เชียงใหม่';
$page_css         = ['/assets/css/services/ipad-style.css?v=1', 'https://unpkg.com/aos@2.3.4/dist/aos.css'];

$faq_schema = [
    ['ซ่อม iPad ที่ CMNS FixMac ราคาเท่าไหร่?',
     'ราคาขึ้นอยู่กับรุ่นและอาการ เช่น เปลี่ยนจอ iPad Air เริ่มที่ 2,500 บาท เปลี่ยนแบตเริ่มที่ 1,500 บาท ทุกงานประเมินฟรีก่อนตัดสินใจ'],
    ['ใช้เวลาซ่อม iPad นานแค่ไหน?',
     'งานทั่วไปเช่น เปลี่ยนจอ เปลี่ยนแบต ใช้เวลา 1–2 วัน ขึ้นอยู่กับสต็อกอะไหล่'],
    ['iPad ที่ซ่อมมีประกันไหม?',
     'มีประกันทุกงานซ่อม 1–6 เดือน ขึ้นอยู่กับประเภทงาน ครอบคลุมทั้งอะไหล่และค่าแรง นำมาเคลมได้ฟรีในช่วงประกัน'],
    ['iPad Pro M4 ซ่อมได้ไหม?',
     'ซ่อมได้ ทีมช่างมีประสบการณ์กับ iPad ทุกรุ่น ทั้ง iPad mini, iPad Air, iPad Pro ชิป M1–M4'],
    ['iPad โดนน้ำ ยังกู้คืนได้ไหม?',
...
<link rel="canonical"      href="https://cmnsfixmac.com/services/ipad/">
...
<meta property="og:url"          content="https://cmnsfixmac.com/services/ipad/">
...
<script type="application/ld+json"><?= json_encode([
    ...
    '@graph'   => [
        ['@type' => 'BreadcrumbList', 'itemListElement' => [
            ...
            ['@type' => 'ListItem', 'position' => 3, 'name' => 'ซ่อม iPad','item' => 'https://cmnsfixmac.com/services/ipad/'],
        ]],
        ['@type' => 'Service',
         'name'  => 'ซ่อม iPad เชียงใหม่',
         'description' => 'บริการซ่อม iPad ทุกรุ่น ทุกอาการ โดยช่างผู้เชี่ยวชาญ อะไหล่แท้ ประกันสูงสุด 6 เดือน',
         ...
         'url'        => 'https://cmnsfixmac.com/services/ipad/',
        ],
...
$repairs = $pdo->query(
    "SELECT id, title, model, image, views FROM repairs
     WHERE status='published' AND TRIM(LOWER(category))='ipad'
...
<section class="sv-hero">
  ...
  <div class="sv-hero-inner">
    ...
    <div class="sv-hero-text" data-aos="fade-right" data-aos-duration="700">
      ...
      <h1 class="sv-h1">ซ่อม iPad<br><span class="sv-h1-accent">ทุกรุ่น ทุกอาการ</span></h1>
    ...
    <div class="sv-hero-visual" data-aos="fade-left" data-aos-duration="700" data-aos-delay="120">
      <div class="sv-device-wrap">
        <img src="/assets/img/ipad.png" alt="ซ่อม iPad เชียงใหม่ CMNS FixMac" class="sv-device-img">
        <div class="sv-float-badge sv-fbadge-1">
          <span class="material-symbols-rounded">build_circle</span>
          <div><strong>800+</strong><span>งานซ่อม iPad</span></div>
        </div>
...
<div class="sv-nav-outer">
  <nav class="sv-nav" data-aos="fade-up" data-aos-offset="0" aria-label="บริการซ่อม Apple">
    ...
    <a href="/services/ipad/"       class="sv-nav-item active"><span class="material-symbols-rounded">tablet_mac</span><span>iPad</span></a>
...
<section class="sv-section sv-services">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>ซ่อม iPad ครบทุกประเภท</h2>
      <p class="sv-desc">รับซ่อม iPad mini, iPad Air, iPad Pro ทุกรุ่น ทั้งชิป A-Series และ M-Series โดยทีมช่างผู้เชี่ยวชาญ</p>
    </div>
    <div class="sv-card-grid">
      <?php foreach ([
          ['display_settings', 'เปลี่ยนจอ iPad',         'จอแตก จอลาย จอไม่ติด ไม่ตอบสนอง เปลี่ยน Retina LCD / OLED ทุกรุ่น', 'เริ่ม 2,500 บาท'],
          ['battery_alert',    'เปลี่ยนแบตเตอรี่',       'แบตเสื่อม ชาร์จไม่อยู่ iPad ดับเร็ว รับเปลี่ยนแบตทุกรุ่น',           'เริ่ม 1,500 บาท'],
          ['water_drop',       'iPad โดนน้ำ',             'น้ำเข้า เครื่องดับ ล้างบอร์ด ซ่อมชิปที่เสียหาย กู้ข้อมูล',           'ประเมินหน้างาน'],
          ['photo_camera',     'เปลี่ยนกล้อง',            'กล้องพัง ภาพเบลอ โฟกัสไม่ได้ เปลี่ยนกล้องหน้า / หลัง',              'เริ่ม 1,200 บาท'],
          ['home_pin',         'เปลี่ยนปุ่ม Home',        'ปุ่ม Home กด response ไม่ดี หรือพัง Touch ID ไม่ทำงาน',              'เริ่ม 800 บาท'],
          ['memory',           'ซ่อม Logic Board',        'iPad ดับ loop เปิดไม่ติด ค้าง Apple Logo ซ่อมระดับชิป',              'ประเมินหน้างาน'],
...
<section class="sv-section sv-pricing" id="sv-pricing">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>ราคาซ่อม iPad โปร่งใส ไม่มีบวกเพิ่ม</h2>
...
<section class="sv-section sv-process">
  <div class="sv-container">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>ซ่อม iPad กับเรา ง่ายแค่ 4 ขั้นตอน</h2>
    </div>
    <div class="sv-steps">
      <?php foreach ([
...
<section class="sv-section sv-gallery">
  <div class="sv-container">
    ...
    <div class="sv-view-all" data-aos="fade-up">
      <a href="/works/?category=iPad" class="sv-more-link">
...
<section class="sv-section sv-faq">
  <div class="sv-container sv-faq-wrap">
    <div class="sv-section-head" data-aos="fade-up">
      ...
      <h2>คำถามที่พบบ่อย ซ่อม iPad</h2>
    </div>
...
<section class="sv-cta">
  <div class="sv-container">
    <div class="sv-cta-inner" data-aos="fade-up">
      <span class="material-symbols-rounded sv-cta-icon">tablet_mac</span>
      <h2>iPad มีปัญหา?<br>ให้เราดูแลให้</h2>
