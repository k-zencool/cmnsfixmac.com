...
-- ############################################################
--  ตรวจผล — ต้องได้ 0 ทั้ง 7 ตัว  << คำสั่งสุดท้ายของไฟล์
--  ตัวไหนไม่เป็น 0 อย่าเพิ่ง push โค้ด มาบอกก่อน
--
--  (บล็อกนี้ต้องเป็นคำสั่งสุดท้ายจริง ๆ ห้ามมีคอมเมนต์ต่อท้าย —
--   phpMyAdmin นับคอมเมนต์ท้ายไฟล์เป็น statement แล้วรายงานว่า
--   "empty result set" ทับผลตรวจทิ้ง)
-- ############################################################
